...
export function getFilePathOrFullPath(fileName: string | undefined, editor: any, workspace: any): string | undefined {
 ...
 */
export function getDocumentWorkspaceFolder(editor: any, workspace: any): string | undefined {
